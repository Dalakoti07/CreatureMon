...
class CreaturePresenter(private val generator: CreatureGenerator= CreatureGenerator()): BasePresenter<CreatureContract.View>()
    ,CreatureContract.Presenter {
    ...
    override fun attributesSelected(attributesType: AttributeType, position: Int) {
        when(attributesType){
